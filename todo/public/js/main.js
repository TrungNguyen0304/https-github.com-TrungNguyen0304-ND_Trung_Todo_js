...
function render() {
    ...
    for (let i = 0; i < todoList.length; i++) {
        ...
        htmlTodoList += `<tr>
                    ...
                    <td><button type="button" class="btn btn-primary" onclick="editTodo(` + i + `)">Sửa</button></td>
                    <td><button type="button" class="btn btn-primary" onclick="deleteTodo(` + i + `)">Xoá</button></td>
                </tr>`;
    }
